...
# ZeroEQ Beta - macOS Installation Helper
# This script removes quarantine attributes and installs the VST3

echo "==========================================="
echo "   ZeroEQ Beta - Installation Helper"
echo "==========================================="
echo ""
...
VST3_FILE="$SCRIPT_DIR/ZeroEQ.vst3"

# Check if VST3 exists
if [ ! -d "$VST3_FILE" ]; then
    echo "❌ ZeroEQ.vst3 not found in the same directory as this script"
...
if [ -d "$VST3_DIR/ZeroEQ.vst3" ]; then
    echo "⚠️  ZeroEQ.vst3 already exists in VST3 folder"
...
# Verify installation
if [ -d "$VST3_DIR/ZeroEQ.vst3" ]; then
    echo "✅ Successfully installed to: $VST3_DIR/ZeroEQ.vst3"
    echo ""
    echo "==========================================="
    ...
    echo "3. Look for 'ZeroEQ' in your effects list"
    echo ""
